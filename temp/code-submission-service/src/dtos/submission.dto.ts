...
export const languageDto = zod.enum(
  Object.values(LanguagesEnum) as [string, ...string[]],
);
export const statusDto = zod.enum(
  Object.values(SubmissionStatusEnum) as [string, ...string[]],
);
