...
router.get('/:problemId', asyncHandler(problemControllerInstance.getProblemById));
...
////////////////////////////////////////////////////////////////////////////
router.use(parseUserHeaders, verifyUserRole([UserRoleEnum.MODERATOR, UserRoleEnum.ADMIN, UserRoleEnum.SUPERADMIN]));
router.post('/', asyncHandler(problemControllerInstance.createProblem));
router.patch('/:problemId', asyncHandler(problemControllerInstance.updateProblem));
